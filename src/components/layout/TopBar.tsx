...
export default function TopBar() {
  ...
  return (
    <>
      {/* Spacer safe-area : couvre la barre de statut du téléphone (heure, batterie…) */}
      <div
        className="bg-nc-blue flex-shrink-0"
        style={{ height: 'env(safe-area-inset-top, 0px)' }}
      />

      <header className="bg-nc-blue text-white px-4 py-3 flex items-center justify-between shadow-md flex-shrink-0">
        {/* Menu mobile */}
        <button
